...
> = {
  ...
  // transports). --append-system-prompt stays accepted for two live paths:
  // older container images that still emit it first-choice, and current
  // transports falling back to the legacy shape when the host CLI predates
  // --system-prompt/--tools.
